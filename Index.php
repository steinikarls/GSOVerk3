<?php include ($_SERVER['DOCUMENT_ROOT'] . '/2t/1810943469/GSO/title.php');?> 	
	<?php include ($_SERVER['DOCUMENT_ROOT'] . '/2t/1810943469/GSO/random_image.php');?> 
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
		<div id="wrapper">
			...
			<nav id="navigation">
				<?php include ($_SERVER['DOCUMENT_ROOT'] . '/2t/1810943469/GSO/header.php');?> 	
			</nav>
			<div class="container">
        ...
        <div class="row">
			...
			<footer>
				<?php include ($_SERVER['DOCUMENT_ROOT'] . '/2t/1810943469/GSO/footer.php');?> 	
			</footer>
